    ...
    : BaseClass(pParent, "GameplayPage", pAssociate), m_cvarPaintColor("mom_paint_color")
{
    ...
    m_pSJShotHighSoundThreshold = new CvarTextEntry(this, "StickyShotHighSoundThreshold", "mom_sj_sound_shot_high_threshold", 2);
    m_pSJShotHighSoundThreshold->SetAllowNumericInputOnly(true);
